...
router.get('/summary', async (req, res) => {
  ...
  // https://jsr.io/@gadicc/yahoo-finance2/doc/modules/quoteSummary
  const modules = ['assetProfile', 'summaryProfile', 'summaryDetail', 'financialData', 'defaultKeyStatistics', 'price']; // 可根據需要擴充
  try {
